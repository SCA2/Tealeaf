...
# object ids of fixnums are the same everywhere.  Same with :symbols
# there are no unintended array side-effects because a new array is created and assigned to a local variable which goes out of scope when the method returns.